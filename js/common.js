jQuery.loadScript = function (url, callback) {
    jQuery.ajax({
        ...
        dataType: 'script',
        success: callback,
		error : function(err){console.log('스크립트 로드  실패');},
        async: true
    });
};
(function() {
...
function zoomAction() {
	...
	var param = $(".responsive-image-zoom");
	var plus = param.find(".plus");
	var moins = param.find(".moins");
	var img = param.find(".image");
	var reset = param.find(".reset");
	var overflow = param.find(".img-container");
